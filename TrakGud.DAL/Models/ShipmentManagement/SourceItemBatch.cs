...
namespace TrakGud.DAL.Models.ShipmentManagement
{
	public class SourceItemBatch: ItemBatch
	{
		...
		public SourceItemBatch(int id_, string itemBatchType_, int productId_, DateTime addTS_, int adderId_, string sourceType_ = default, int? sourceId_ = default, int? modderId_ = default, bool? isRemoved_ = default, DateTime modTS_ = default, float? shippedQty_ = default, int? shippedUnitId_ = default): base(id_, itemBatchType_, productId_, addTS_, adderId_, sourceType_, sourceId_, modderId_, isRemoved_, modTS_)
		{
